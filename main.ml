...
let send_quit st = sendMsg st "quit"; quit (Some st)
...
(** [play_network st] begins and continues playing a game available to be 
    played across several different computers *)
...
(** [new_network_game st] plays a networked game represented by [st] *)
...
(** [host_client ()] selects the role of the current player in a networked game. 
*)
and host_client g =
